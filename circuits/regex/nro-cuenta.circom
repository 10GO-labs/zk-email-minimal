...
// regex: N=FAmero de cuenta:  <strong>[0-9]+<
template RegexNroCuenta(msg_bytes) {
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][4] * states[i+2][5];
